...
const Page: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-lightOne text-black dark:text-[#D0D4D0] dark:bg-darkOne lg:py-10 ">
      <div className="flex items-center p-4 mx-auto flex-col space-y-4 max-w-[1000px] ">
        ...
        <button style={{ backgroundColor: color }} className={`p-4 w-full max-w-[500px] md:mx-auto rounded-lg flex justify-center items-center space-x-2 capitalize`}> <h3 className="">Edit Profile</h3> <Edit /> </button>

      </div>

      <div className=" w-full p-4 max-w-[1000px] mx-auto gap-4 grid grid-cols-3 md:grid-cols-4 lg:flex   fill-[#E1E1E1] dark:fill-[#17191D] has-[div]:drop-shadow-lg has-[div]:cursor-pointer dark:text-[#17191D] text-[#E1E1E1] font-bold ">

        <div className="flex justify-center items-center w-[100px] h-[100px] mx-auto flex-col space-y-4 rounded-lg bg-[#ffd437] " onClick={() => router.push("profile/saved")}>
          <Save />
